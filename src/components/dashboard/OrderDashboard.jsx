...
export const OrderDashboard = () => {
  const handleChange = async (e) => {
    ...
    await axios
      .put("https://techstore123.herokuapp.com/orders", e.target.value)
      ...
      renderCell: (cellValues) => {
        return (
          <FormControl fullWidth>
            ...
            >
              <MenuItem value={{ status: "approved", id: cellValues.id }}>
                Aprobado
              </MenuItem>
              <MenuItem value={{ status: "Enviado", id: cellValues.id }}>
                Enviado
              </MenuItem>
              <MenuItem value={{ status: "Completado", id: cellValues.id }}>
                Finalizado
              </MenuItem>
            </Select>
          </FormControl>
